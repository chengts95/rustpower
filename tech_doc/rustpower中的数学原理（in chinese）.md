...
\begin{equation}
\begin{aligned}
         \bm F(\bm V) = S_{bus} - \bm S_{inj} = 0
\end{aligned}
\end{equation}
$$
其中 $\bm F$ 是构造出的在方程的根处等于0的函数，即节点功率平衡，$\bm S_{inj}$是电源以及负荷注入节点的功率，是一个常数。其迭代格式的雅各比矩阵（实数PQ矩阵）和电压向量为:
$$
\begin{equation}
\begin{aligned}
          J & = \begin{bmatrix}
...
作者简介：程天石，他于2017年获得中国东南大学电气工程及其自动化学士学位。从2017年到2018年，他在中国南瑞集团公司（国家电网电力科学研究院）担任变电站自动化工程师。目前，他正在加拿大阿尔伯塔大学攻读电气与计算机工程博士学位。他的研究兴趣包括电磁暂态仿真、暂态稳定性分析、实时仿真、网络物理系统、并行处理、微电网和电力电子。

<!-- 在此我不禁感叹，当年的电子信息技术潮流当中并不缺少中国人研究去EDA软件，却不知为何在大约40年后成了“卡脖子”技术，令人唏嘘。  -->
