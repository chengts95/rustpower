...
use crate::basic::ecs::elements::generator::{
    GeneratorCfg, Slack, TargetPMW, TargetQMVar, TargetVmPu,
};
...
impl BusHandle {
    ...
    fn vm_pu(&self, py: Python<'_>) -> PyResult<f64> {
        ...
        grid_py
            .inner
            .world()
            .get::<VBusResult>(self.entity())
            .map(|v| v.0.norm())
            .ok_or_else(|| {
                PyErr::new::<pyo3::exceptions::PyRuntimeError, _>(
                    "No result at this bus: call solve() first",
                )
            })
    }
...
impl LoadHandle {
    ...
    #[setter]
    fn set_p_mw(&self, py: Python<'_>, value: f64) -> PyResult<()> {
        self.set_p(py, value)
    }
    ...
    #[setter]
    fn set_q_mvar(&self, py: Python<'_>, value: f64) -> PyResult<()> {
        self.set_q(py, value)
    }
    ...
    fn set_p(&self, py: Python<'_>, value: f64) -> PyResult<()> {
        ...
        if mutation::set_load_p(grid_py.inner.world_mut(), self.entity(), value) {
            ...
            Err(PyErr::new::<pyo3::exceptions::PyValueError, _>(
                "Not a Load entity (missing TargetPMW)",
            ))
        }
    }
    ...
    fn set_q(&self, py: Python<'_>, value: f64) -> PyResult<()> {
        ...
        if mutation::set_load_q(grid_py.inner.world_mut(), self.entity(), value) {
            ...
            Err(PyErr::new::<pyo3::exceptions::PyValueError, _>(
                "Not a Load entity (missing TargetQMVar)",
            ))
        }
    }
}
...
impl GenHandle {
    ...
    fn bus(&self, py: Python<'_>) -> PyResult<i64> {
        ...
        grid_py
            ...
            .map(|b| b.0)
            .ok_or_else(|| {
                PyErr::new::<pyo3::exceptions::PyValueError, _>("Not a Generator entity")
            })
    }
    ...
    #[setter]
    fn set_vm_pu(&self, py: Python<'_>, value: f64) -> PyResult<()> {
        self.set_vm(py, value)
    }
...
impl LineHandle {
    ...
    fn p_from_mw(&self, py: Python<'_>) -> PyResult<f64> {
        ...
        grid_py
            .inner
            .world()
            .get::<LineResultData>(self.entity())
            .map(|d| d.p_from_mw)
            .ok_or_else(|| {
                PyErr::new::<pyo3::exceptions::PyRuntimeError, _>(
                    "No result on this line: call solve() first",
                )
            })
    }
...
impl TrafoHandle {
    fn __repr__(&self) -> String {
        format!("TrafoHandle({})", self.entity)
    }
}
#[pymethods]
impl ExtGridHandle {
    fn __repr__(&self) -> String {
        format!("ExtGridHandle({})", self.entity)
    }
}
#[pymethods]
impl ShuntHandle {
    fn __repr__(&self) -> String {
        format!("ShuntHandle({})", self.entity)
    }
}
#[pymethods]
impl SGenHandle {
    fn __repr__(&self) -> String {
        format!("SGenHandle({})", self.entity)
    }
}
#[pymethods]
impl SwitchHandle {
    fn __repr__(&self) -> String {
        format!("SwitchHandle({})", self.entity)
    }
}
