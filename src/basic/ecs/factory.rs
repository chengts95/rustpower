...
pub trait GridFactory {
    ...
    fn add_trafo(
        ...
        lv_bus: i64,
        std_type: Option<String>,
        params: Option<TransformerDevice>,
        name: Option<String>,
    ) -> Entity;
    fn add_shunt(
        &mut self,
...
impl GridFactory for PowerGrid {
    ...
    fn add_std_line_type(&mut self, name: String, r: f64, x: f64, c: f64, g: f64, max_i: f64) {
        ...
        self.world_mut()
            .resource_mut::<StdTypeLibrary>()
            .add_line_type(name, r, x, c, g, max_i);
    }
    ...
    fn add_std_trafo_type(
        ...
        self.world_mut()
            .resource_mut::<StdTypeLibrary>()
            .add_trafo_type(name, sn_mva, vn_hv, vn_lv, vk, vkr, pfe, i0);
    }
    ...
    fn add_line(
        ...
        let final_params = if let Some(st) = std_type.clone() {
            let lib = self
                .world()
                .get_resource::<StdTypeLibrary>()
                .expect("StdTypeLibrary not initialized");
        ...
        if let Some(st) = std_type {
            buffer.insert(world, entity, StandardModelType(st));
        }
        entity
    }
