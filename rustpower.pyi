...
class NewtonSolver:
    ...
    def setup_context(
        ...
        v_init: np.ndarray,
        to_perm: np.ndarray,
        from_perm: np.ndarray,
        npv: int,
        npq: int,
    ) -> None: ...
    def solve(self, max_iter: int = 10, tol: float = 1e-6) -> bool: ...
    ...
    def extract_results(
        ...
        va_deg: Optional[np.ndarray] = None,
        scalc: Optional[np.ndarray] = None,
        p_calc: Optional[np.ndarray] = None,
        q_calc: Optional[np.ndarray] = None,
    ) -> None: ...
    def get_voltage(self) -> np.ndarray: ...
    def get_voltage_magnitude(self) -> np.ndarray: ...
    def get_voltage_angle(self, deg: bool = False) -> np.ndarray: ...
    def get_scalc(self) -> np.ndarray: ...
    def get_p_injections(self) -> np.ndarray: ...
    def get_q_injections(self) -> np.ndarray: ...
    ...
    @property
    def scalc(self) -> np.ndarray: ...
    @property
    def p_calc(self) -> np.ndarray: ...
    @property
    def q_calc(self) -> np.ndarray: ...
    @property
    def to_perm(self) -> np.ndarray: ...
    @property
    def from_perm(self) -> np.ndarray: ...
    @property
    def p_vec(self) -> np.ndarray: ...
    @property
    def p_inv(self) -> np.ndarray: ...
    @property
    def npv(self) -> int: ...
    @property
    def npq(self) -> int: ...
    ...
    @property
    def s_bus(self) -> np.ndarray: ...
    @s_bus.setter
    def s_bus(self, value: np.ndarray) -> None: ...
    @property
    def v_init(self) -> np.ndarray: ...
    @v_init.setter
    def v_init(self, value: np.ndarray) -> None: ...
    def set_s_bus_at(self, bus: int, s: complex) -> None: ...
    def update_s_bus_batch(self, buses: np.ndarray, s_values: np.ndarray) -> None: ...
    def set_v_init_at(self, bus: int, v: complex) -> None: ...
    def update_v_init_batch(self, buses: np.ndarray, v_values: np.ndarray) -> None: ...
